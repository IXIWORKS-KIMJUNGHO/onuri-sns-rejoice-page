...
const quizDataByDifficulty = {
  easy: [
    ...
    { id: 2, emoji: '☔✅', answer: '비 준비하시니' },
    { id: 3, emoji: '👥🧔👑🗣️🎵', answer: '우리 주안에서 노래하며' },
    { id: 4, emoji: '🔙✝️🧔👑', answer: '여호와께 돌아가자' },
    { id: 5, emoji: '🧔👑👁️👁️', answer: '주를 바라보며' },
    { id: 6, emoji: '👉🌸', answer: '너는 꽃이야' },
    { id: 7, emoji: '🧔👑📞', answer: '하나님의 부르심' },
    { id: 8, emoji: '🥰🧔👑➡️👶⤵️🌏', answer: '기쁘다 구주 오셨네' },
    { id: 9, emoji: '🕳️⬇️', answer: '낮은 곳으로' },
  ],
  normal: [
    { id: 1, emoji: '👥🤝🧔👑', answer: '우린 주를 만나고' },
    { id: 2, emoji: '👤🙏🧔👑', answer: 'I thank GOD' },
    { id: 3, emoji: '👥❤️❤️❤️🧔👑', answer: '우리가 주를 더욱 사랑하고' },
    { id: 4, emoji: '🔍🧔👑👨‍👩‍👧‍👦', answer: '주를 찾는 모든 자들이' },
    { id: 5, emoji: '🧔👑🌍', answer: '하나님의 세계' },
    { id: 6, emoji: '💪🦵🧔👑⛪', answer: '내 몸은 구주의 성전이니' },
    { id: 7, emoji: '🧔👑🔥', answer: '하나님의 열심' },
    { id: 8, emoji: '⏰🚀➡️', answer: '시간을 뚫고' },
  ],
  hard: [
    { id: 1, emoji: '🙋🧔👑🤲🏻😮‍💨🙅', answer: '나는 주를 섬기는 것에 후회가 없습니다' },
    { id: 2, emoji: '🧑‍🧑‍🧒‍🧒🗣️🎶⛪', answer: '회중찬양' },
    { id: 3, emoji: '🔄🌙❌', answer: '다시 밤이 없겠고' },
    { id: 4, emoji: '🫂🧱⛪', answer: '함께 지어져 가네' },
    { id: 5, emoji: '🧔👑👉💯❤️❤️❤️', answer: '하나님이 너를 엄청 사랑하신대' },
    { id: 6, emoji: '❤️👭👬🧑‍🧑‍🧒‍🧒🗣️🎶', answer: '사친다노' },
    { id: 7, emoji: '❤️🌸👙🍂☃️', answer: '사랑의 계절은' },
    { id: 8, emoji: '👁️👂👤', answer: '보고 들은 자' },
  ],
}
